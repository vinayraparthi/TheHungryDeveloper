...
public class DessertsActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ListView dessertCoursesList = findViewById(R.id.list_view_desserts);

        Dish[] dessertsCourses= {
        ...
        ArrayAdapter<Dish> dishArrayAdapter = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1,dessertsCourses);

        dessertCoursesList.setAdapter(dishArrayAdapter);
